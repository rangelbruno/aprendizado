    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form id="kt_modal_exportar_permission_form" class="form" action="{{ route('usuarios.export') }}"
                    method="post">
                    @csrf
                    <!--begin::Input group-->
                    <div class="fv-row mb-10">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <select name="format" data-control="select2" data-placeholder="Escolha um formato"
    ...
    document.addEventListener("DOMContentLoaded", function() {
        var KTUsersAddPermission = (function() {
            const modalElement = document.getElementById("kt_modal_add_permission"),
                formElement = modalElement.querySelector("#kt_modal_exportar_permission_form"),
